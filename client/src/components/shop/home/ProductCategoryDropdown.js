...
const FilterList = () => {
  ...
  return (
    <div className={`${data.filterListDropdown ? "" : "hidden"} my-4 px-5`}>
      <hr />
      <div className="w-full flex flex-col" style={{ minWidth: "40vw" }}>
...
const Search = () => {
  ...
  return (
    <div
      ...
      } my-4 flex items-center justify-between py-0`}
      style={{ paddingLeft: "2rem" }}
    >
      <input
        value={search}
        onChange={(e) => searchHandle(e)}
        className="px-4 text-xl py-1 focus:outline-none"
        type="text"
